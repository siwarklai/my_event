...
import ev from './components/eventsAdmin/events';
import Show from './components/eventsAdmin/Showevent';
import Create from './components/eventsAdmin/Createevent';
import Edit from './components/eventsAdmin/Editevent';
import Delete from './components/eventsAdmin/Deleteevent';
import './App.css';
        ...
        <Routes>
            {user ? (
                <>
                    ...
                    <Route path="/event" exact element={<ev/>} />
                    <Route path="/event/create" element={<Create />} />
                    <Route path="/event/details/:id" element={<Show />} />
                    <Route path="/event/edit/:id" element={<Edit />} />
                    <Route path="/event/delete/:id" element={<Delete />} />
                    {/* User CRUD Routes */}
