...
import Showevent from './components/eventsAdmin/Showevent';
import Createevent from './components/eventsAdmin/Createevent';
import Editevent from './components/eventsAdmin/Editevent';
import Deleteevent from './components/eventsAdmin/Deleteevent';
import './App.css';
        ...
        <Routes>
            {user ? (
                <>
                    ...
                    <Route path="/event" exact element={<E*vent/>} />
