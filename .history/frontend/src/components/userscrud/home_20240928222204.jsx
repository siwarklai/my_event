                ...
                <table className='w-full border-separate border-spacing-2'>
                    <thead>
                        <tr>
                            ...
                            <th className='border border-slate-600 rounded-md max-md:hidden'>Staut</th>
                            ...
                            <th className='border border-slate-600 rounded-md max-md:hidden'>Numéro de téléphone</th>
