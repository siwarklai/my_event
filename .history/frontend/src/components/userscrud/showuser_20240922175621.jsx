  ...
  return (
    <div className='p-4'>
      ...
      {loading ? (
        ...
        < center div className='flex flex-col border-2 border-sky-400 rounded-xl w-fit p-4 bg-white'>
          ...
          <div className='my-4'>
            <span className='text-xl mr-4 text-gray-500'>Numéro de télephone:</span>
          ...
          <div className='my-4'>
            <span className='text-xl mr-4 text-gray-500'>Dernière mise à jour à:</span>
