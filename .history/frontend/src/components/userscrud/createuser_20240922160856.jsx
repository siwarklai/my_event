...
const CreateUser = () => {
  ...
  const handleSaveUser = () => {
    if (!firstname || !lastname || !email || !password || !ID || !position || !phone) {
      window.alert('Please fill all fields'); // Window alert
    ...
    axios
      ...
      .catch((error) => {
        ...
        window.alert('vérifie tous les champs'); 
  ...
  return (
    <div className='p-4'>
      ...
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        <div className='my-4'>
          <label className='text-2xl mr-4 text-black'>First Name</label>
          <input
            type='text'
            value={firstname}
        ...
        <div className='my-4'>
          <label className='text-2xl mr-4 text-black'>Last Name</label>
          <input
            type='text'
            value={lastname}
        ...
        <div className='my-4'>
          <label className='text-2xl mr-4 text-black'>Password</label>
          <input
            type='password'
            value={password}
        ...
        <div className='my-4'>
          <label className='text-2xl mr-4 text-black'>ID</label>
          <input
            type='text'
        ...
        <div className='my-4'>
          <label className='text-2xl mr-4 text-black'>Phone</label>
          <input
            type='text'
            value={phone}
