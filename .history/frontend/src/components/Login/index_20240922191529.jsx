...
const Login = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
		  ...
		  // Check if account is suspended before storing the token
		  if (status === "suspendu") {
		  ...
		  setError(error.response?.data?.message || "La connexion a échoué! Veuillez vérifier vos informations d'identification et réessayer.");
		}
	  };
