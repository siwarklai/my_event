  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch((error) => {
        ...
        window.alert('Error occurred while updating event');
        console.log(error);
      });
  };
  ...
  return (
    <div className='p-4'>
      ...
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        <div className='my-4'>
          <label className='text-xl mr-4 text-black'>Nom</label>
          <input
            type='text'
            value={nom}
        ...
        <div className='my-4'>
          <label className='text-xl mr-4 text-black'>Type</label>
          <input
            type='text'
            value={type}
        ...
        <div className='my-4'>
          <label className='text-xl mr-4 text-black'>Lieu</label>
          <input
            type='text'
            value={lieu}
        ...
        <div className='my-4'>
          <label className='text-xl mr-4 text-black'>Code Postale</label>
          <input
            type='number'
            value={codePostale}
        ...
        <div className='my-4'>
          <label className='text-xl mr-4 text-black'>Date Début</label>
          <input
            type='date'
            value={dateDebut}
        ...
        <div className='my-4'>
          <label className='text-xl mr-4 text-black'>Date Fin</label>
          <input
            type='date'
            value={dateFin}
        ...
        <div className='my-4'>
          <label className='text-xl mr-4 text-black'>Budget</label>
