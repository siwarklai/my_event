    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((response) => {
                ...
                setEvents(response.data.data || []); // Safely set events to an empty array if undefined
                setLoading(false);
            })
            .catch((error) => {
                console.log(error);
                ...
                <table className='w-full border-separate border-spacing-2'>
                    <thead>
                        <tr>
                            ...
                            <th className='border border-slate-600 rounded-md max-md:hidden'>Crée par</th>
                        ...
                        {events.length > 0 ? (
                            events.map((event, index) => (
                                <tr key={event._id} className='h-8'>
                                    ...
                                    <td className='border border-slate-700 rounded-md text-center max-md:hidden'>{event.creator}</td>
